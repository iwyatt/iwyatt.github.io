...
(emscripten_shaders_hack = !1),
    (importObject = {
        env: {
            // added to allow getting unix epoch in nanoseconds for sendings logs to loki
            get_real_unix_millis: () => {
                // Use Performance.now() + Performance.timeOrigin for best accuracy
                return performance.timeOrigin + performance.now();
                // Or just Date.now() if that's easier and sufficient (less accurate, but still epoch-based)
                // return Date.now();
            },
            ...
            run_animation_loop: function (e) {
                (canvas.onmousemove = function (e) {
                    ...
                    window.addEventListener("paste", function (e) {
                        ...
                        t != null &&
                            t.length != 0 &&
                            ((n = new TextEncoder().encode(t).length), (s = wasm_exports.allocate_vec_u8(n)), (o = new Uint8Array(wasm_memory.buffer, s, n)), stringToUTF8(t, o, 0, n), wasm_exports.on_clipboard_paste(s, n));
                    }),
...
(function () {
    ...
    function d() {
        if (e == null) {
            ...
            let n = e.listener;
            {
                ...
                document.addEventListener("touchstart", t), document.addEventListener("touchend", t), document.addEventListener("mousedown", t), document.addEventListener("keydown", t);
            }
        }
    }
    function r(t, s) {
    ...
    function l() {
        ...
        return n != null ? (n.source = e.createBufferSource()) : ((n = { sound_key: 0, playback_key: 0, source: e.createBufferSource(), gain_node: e.createGain(), ended: null }), t.push(n)), n;
    }
    function s(e) {
        try {
            e.source.removeEventListener("ended", e.ended), e.source.disconnect(), e.gain_node.disconnect(), (e.sound_key = 0), (e.playback_key = 0);
        } catch (e) {
    ...
    function u(t, o, i) {
        ...
        try {
            (a.source.buffer = n.get(t)), a.source.start(0);
        } catch (e) {
    ...
    miniquad_add_plugin({ register_plugin: v, version: 1, name: "macroquad_audio" });
})(),
    (function () {
        "use strict";
        var n,
        ...
        function o(n) {
            (n.env.js_create_string = function (e, n) {
                ...
                (n.env.js_create_buffer = function (e, n) {
                    ...
                    return o.set(new Uint8Array(s)), t(o);
                }),
                ...
                (n.env.js_unwrap_to_str = function (t, n, o) {
                    for (var r = e[t], a = s(r), c = a.length, l = new Uint8Array(wasm_memory.buffer, n, o), i = 0; i < c; i++) l[i] = a[i];
                }),
                (n.env.js_unwrap_to_buf = function (t, n, s) {
                    for (var i = e[t], a = i.length, r = new Uint8Array(wasm_memory.buffer, n, s), o = 0; o < a; o++) r[o] = i[o];
                }),
        ...
        miniquad_add_plugin({ register_plugin: o, version: 1, name: "sapp_jsutils" });
        function s(e) {
            for (var t, n = [], s = 0; s < e.length; s++)
                (t = e.charCodeAt(s)),
                    t < 128
                        ? n.push(t)
                        : t < 2048
                        ? n.push(192 | (t >> 6), 128 | (t & 63))
                        : t < 55296 || t >= 57344
                        ? n.push(224 | (t >> 12), 128 | ((t >> 6) & 63), 128 | (t & 63))
                        : (s++, (t = 65536 + (((t & 1023) << 10) | (e.charCodeAt(s) & 1023))), n.push(240 | (t >> 18), 128 | ((t >> 12) & 63), 128 | ((t >> 6) & 63), 128 | (t & 63)));
            return n;
        }
        function t(t) {
            if (t == null) return -2;
        ...
        window.js_object = t;
        window.consume_js_object = a;
    })(),
    (function () {
        function l() {}
        function d(e) {
            (e.env.ws_connect = a), (e.env.ws_is_connected = i), (e.env.ws_send = r), (e.env.ws_try_recv = c), (e.env.http_make_request = h), (e.env.http_try_recv = u);
        }
        miniquad_add_plugin({ register_plugin: d, on_init: l, version: 1, name: "quad_net" });
        var e,
            t,
            s,
            o = 0,
        ...
        function a(e) {
            (t = new WebSocket(window.consume_js_object(e))),
                (t.binaryType = "arraybuffer"),
                (t.onopen = function () {
                    o = 1;
                }),
                (t.onmessage = function (e) {
                    if (typeof e.data == "string") n.push({ text: 1, data: e.data });
                    else {
                        var t = new Uint8Array(e.data);
                        n.push({ text: 0, data: t });
                    }
                });
        }
        function r(e) {
            var n = window.consume_js_object(e);
            n.buffer != void 0 ? t.send(n.buffer) : t.send(n);
        }
        function c() {
            return n.length != 0 ? window.js_object(n.shift()) : -1;
        }
        (s = 0), (e = {});
        function u(t) {
            if (e[t] != void 0 && e[t] != null) {
                var n = e[t];
                return (e[t] = null), window.js_object(n);
            }
            return -1;
        }
        function h(t, n, o, i) {
            ...
            (s += 1),
                ...
                t == 2 && (r = "GET"),
                t == 3 && (r = "DELETE"),
                (d = window.consume_js_object(n)),
                (u = window.consume_js_object(o)),
                (c = window.consume_js_object(i)),
            ...
            return (
                ...
                (a.onerror = function (e) {
                    console.error("Failed to make a request"), console.error(e);
                }),
                a.send(u),
                l
            );
